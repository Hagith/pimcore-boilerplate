...
<head>
  ...
  <?php if ($this->printermarks) { ?>
    <link rel="stylesheet" type="text/css" href="/pimcore/static6/css/print/print-printermarks.css"
          media="print"/>
  <?php } ?>
...
<div id="site">
  <div class="page">
    <div id="logo">
      <a href="http://www.pimcore.org/"><img style="width: 200px"
                                             src="/pimcore/static6/img/logo.png"/></a>
      <hr/>
      <div class="claim">
